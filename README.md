...
รวม **90 ลิงก์** จาก **81 URL ที่ไม่ซ้ำกัน** — ตรวจสอบครั้งล่าสุดว่าตอบกลับ HTTP 200 ทุกลิงก์เมื่อ 19 ส.ค. 2026

> ไม่มีระบบตรวจสอบอัตโนมัติแล้ว หากนำ deck ไปใช้อีกครั้ง ควรไล่เช็คลิงก์และข้อเท็จจริงกับต้นทางก่อน
> คำสั่งเช็คลิงก์ทั้งหมดอยู่ใน [CLAUDE.md](CLAUDE.md)
